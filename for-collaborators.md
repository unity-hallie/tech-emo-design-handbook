...
This page is for people working on the book, not people reading it. If you came here to read the handbook, the front door is the [README](./README.md). If you came here to help write or shape the handbook, this is where the longer thinking lives — who the book is for, what it draws on, and how we decide what counts as ready.
...
Moved from README on 2026-05-18 when the README became a plain index.*
</content>
</invoke>